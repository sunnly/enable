...
import wang.sunnly.enable.runner.ServerLoad1Runner;
 ...
 */
@Configurable
public class SunnlyScheduled1AutoConfig {
...
//    @ConditionalOnProperty(prefix = "sunnly.enabled", name = "run")
    protected ServerLoad1Runner serverLoad1Runner() {
        return new ServerLoad1Runner();
    }
}
